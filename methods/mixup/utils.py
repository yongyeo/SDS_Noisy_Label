...
from methods.mixup.models import BertConfig, MixupBertForSequenceClassification, RobertaConfig
...
class MixupTrainer(Trainer):
    ...
    def custom_training_step(self, model: nn.Module, inputs: Dict[str, Union[torch.Tensor, Any]], cur_epoch: Optional[Any]) -> torch.Tensor:
        """
